...
import { LayoutDashboard, Users, UserCheck, Shield, Menu, User as UserIcon } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-64 transition-all duration-300">
        <header className="h-16 border-b border-border/40 glass-card flex items-center justify-between px-4 sticky top-0 z-30">
          <div className="flex items-center">
            ...
            <h1 className="font-heading font-semibold text-lg hidden sm:block">Admin Workspace</h1>
          </div>
